...
export default function App(): JSX.Element {
  ...
  const topicPct =
    allTopics.length === 0
      ? 0
      : Math.round((allTopics.filter((t) => t.done).length / allTopics.length) * 100);
  ...
  return (
    <div className="min-h-dvh md:flex">
      ...
      <div className="flex min-h-dvh flex-1 flex-col">
        {/* mobile brand bar (sidebar shows the brand on desktop) */}
        <header className="flex-none px-4 pb-1 pt-4 md:hidden">
          <span
            style={{
